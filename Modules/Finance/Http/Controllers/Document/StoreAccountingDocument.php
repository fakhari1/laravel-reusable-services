...
/**
 * @OA\Post(
 *     path="/api/workshops/accounting/documents/store",
 ...
 * )
 */
class StoreAccountingDocument extends BaseCrudHandler
{
    use AsStaticRunner;
    public function execute(array $attributes = [])
    {
        ...
        $document = AccountingDocument::create([
            ...
            'subjectable_type' => $attributes['subjectable_type'] ?? null,
            'subjectable_id' => $attributes['subjectable_id'] ?? null,
    ...
    public function validate()
    {
        return [
            ...
            'subjectable_type' => ['nullable'],
            'subjectable_id' => ['nullable'],
        ];
    }
        ...
        foreach ($attributes['articles'] as $key => $article) {
            ...
            if (
                ...
                throw ValidationException::withMessages([
                    "برای آرتیکل {$number} بدهکار/بستانکار همزمان با مقدار ارسال شده است ",
                ]);
            }
            ...
            if (
                ...
                throw ValidationException::withMessages([
                    "برای آرتیکل {$number} بدهکار/بستانکار همزمان خالی ارسال شده است ",
                ]);
            }
            ...
            if (
                ...
                throw ValidationException::withMessages([
                    "برای آرتیکل {$number} بدهکار/بستانکار با مقدار منفی ارسال شده است ",
                ]);
            }
        }
    }
